...
const getLog = (request, response) => {
    ...
    const queryParams = separator !== -1
        ? JSON.stringify((0, query_string_1.parse)(requestUrl.substr(separator)))
        : undefined;
    try {
